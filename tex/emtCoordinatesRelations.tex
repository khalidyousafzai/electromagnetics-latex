...
\\
\begin{table}
\caption*{نلکی اکائی سمتیات کا کارتیسی اکائی سمتیات کے ساتھ عددیہ ضرب۔}
\centering
...
\\
\begin{table}
\caption*{کروی  اکائی سمتیات کا کارتیسی اکائی سمتیات کے ساتھ عددیہ ضرب۔}
\centering
\begin{tabular}{l | r r r}
 & $\ax$ & $\ay$ & $\az$ \\
\hline
...
\\
\begin{table}
\caption*{کروی  اکائی سمتیات کا نلکی اکائی سمتیات کے ساتھ عددیہ ضرب۔}
\centering
\begin{tabular}{l | r r r}
 & $\arho$ & $\aphi$ & $\az$ \\
\hline
