...
\begin{axis}[ymin=-2,ymax=6,axis x line*=middle, axis y line*=middle,xtick={0,10,20,30,40,50},xticklabels={90,80,70,60,50,40}
]
\addplot [domain=40:58,smooth](90-x,{funcA(x)});
\addplot [domain=62:79,smooth](90-x,{funcA(x)})coordinate[pos=0](fA);
\addplot [domain=81:90,smooth](90-x,{funcA(x)});

\addplot [domain=41.83:83,smooth](90-x,{funcB(x)}) node [scale=0.7,pos=0.92,pin={right:{$\frac{\sqrt{n_1^2 \sin^2 \theta_i-n_2^2}}{n_1 \cos \theta_i}$}},inner sep=0pt] {};
...
\addplot[mark=none,stealth-] coordinates{(90-41.81,-0.2)(90-41.81,-1.3)}node[below]{$41.8^{\circ}$};


%\pgfplotsset{
  %  after end axis/.code={
    %    \node[red,above] at (axis cs:55,0){\small{'12 MTT}};
      %  \node[red,below] at (axis cs:55,-2){\small{65nm CMOS}};}}
