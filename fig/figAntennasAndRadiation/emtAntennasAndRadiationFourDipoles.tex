...
\begin{tikzpicture}[
declare function={myfunc(\x)=(cos(90*cos(\x)))^3;
                 },
]
...
\draw(-1.5*\len,0)node[circle,fill=black,inner sep=0pt,minimum size=3pt]{};
\draw(1.5*\len,0)node[circle,fill=black,inner sep=0pt, minimum size=3pt]{};
\draw(-0.5*\len,5)node[circle,fill=black,inner sep=0pt, minimum size=3pt]{};
\draw(-0.5*\len,0)node[circle,fill=black,inner sep=0pt, minimum size=3pt]{};
\draw(-0.5*\len,-5)node[circle,fill=black,inner sep=0pt, minimum size=3pt]{};
\draw(0.5*\len,5)node[circle,fill=black,inner sep=0pt, minimum size=3pt]{};
\draw(0.5*\len,0)node[circle,fill=black,inner sep=0pt, minimum size=3pt]{};
\draw(0.5*\len,-5)node[circle,fill=black,inner sep=0pt, minimum size=3pt]{};
