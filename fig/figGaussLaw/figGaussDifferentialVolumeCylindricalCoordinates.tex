...
\usepackage{tikz}
 ...
 \pgfmathsetmacro{\rhost}{0.75}            %start points, lower left corner
 \pgfmathsetmacro{\phist}{35}
 \pgfmathsetmacro{\zst}{0.4}

\pgfmathsetmacro{\rhodel}{0.2}            %changes
 \pgfmathsetmacro{\phidel}{15}
 \pgfmathsetmacro{\zdel}{0.2}
