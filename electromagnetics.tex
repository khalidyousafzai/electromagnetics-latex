...
{./fig/figConductorDielectricCapacitor/}{./fig/figStreamlines/}}		%paths to figures




%\includeonly{./tex/emtSymbols,./tex/emtPreface,./tex/prefaceFirstBook,./tex/emtVectors,./tex/emtCoulombLaw,./tex/emtGaussLaw,./tex/emtEnergyAndPotential,./tex/emtConductorDielectricCapacitor,./tex/emtPoissonLaplace,./tex/emtDataTables,./tex/emtQuestions}
\includeonly{./tex/emtSymbols,./tex/emtPreface,./tex/prefaceFirstBook,./tex/emtConductorDielectricCapacitor,./tex/emtPoissonLaplace,./tex/emtDataTables,./tex/emtQuestions}
