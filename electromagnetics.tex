...
%
%\includeonly{./tex/emtSymbols,./tex/emtPreface,./tex/prefaceFirstBookneticField,./tex/emtVectors,./tex/emtLinearAlgebra,./tex/emtDataTables,./tex/emtEndOfBookTableDivergenceCurlGradientLaplacian,./tex/emtCoordinatesRelations}
%\includeonly{./tex/emtSymbols,./tex/emtPreface,./tex/prefaceFirstBook,./tex/emtConductorDielectricCapacitor,./tex/emtMagneticForcesMaterialsAndInductance,./tex/emtDataTables,./tex/emtEndOfBookTableDivergenceCurlGradientLaplacian,./tex/toDoList}
