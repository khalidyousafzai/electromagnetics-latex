...
{./fig/figConductorDielectricCapacitor/}{./fig/figStreamlines/}{./fig/figPoissonLaplace/}{./fig/figSteadyMagneticField/}{./fig/figMagneticForcesMaterialsAndInductance/}{./fig/figMaxwellEquations/}{./fig/figPlaneWave/}{./fig/figTransmissionLines/}}		%paths to figuree


%\includeonly{./tex/emtSymbols,./tex/emtPreface,./tex/prefaceFirstBook,./tex/emtVectors,./tex/emtCoulombLaw,./tex/emtGaussLaw,./tex/emtEnergyAndPotential,./tex/emtConductorDielectricCapacitor,./tex/emtPoissonLaplace,./tex/emtSteadyMagneticField,./tex/emtMagneticForcesMaterialsAndInductance,./tex/emtDataTables,./tex/emtMaxwellEquations,./tex/emtPlaneWave,./tex/emtTransmissionLines,./tex/emtQuestions}
\includeonly{./tex/emtSymbols,./tex/emtPreface,./tex/prefaceFirstBook,./tex/emtMaxwellEquations,./tex/emtPlaneWave,./tex/emtTransmissionLines,./tex/emtQuestions,./tex/emtDataTables}
