...
{./fig/figConductorDielectricCapacitor/}{./fig/figStreamlines/}{./fig/figPoissonLaplace/}}		%paths to figures
...
\includeonly{./tex/emtSymbols,./tex/emtPreface,./tex/prefaceFirstBook,./tex/emtPoissonLaplace,./tex/emtDataTables,./tex/emtQuestions}
