...
\includeonly{./tex/emtSymbols,./tex/emtPreface,./tex/prefaceFirstBook,./tex/emtTransmissionLines,./tex/emtPolarization,./tex/emtObliqueIncidence,./tex/emtWaveguidesAndResonators,./tex/emtQuestions,./tex/emtDataTables}
