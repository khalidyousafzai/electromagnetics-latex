...
\sisetup{
math-micro=\textup{µ},text-micro=µ,math-ohm  =\upOmega,
text-degree=°,math-degree=\textup{°}} 		%with mathpazo this is needed else must not be here. now size of micro is smaller
...
\pagestyle{empty}
\newpage
\addcontentsline{toc}{chapter}{دیباچہ}
\include{./tex/emtPreface}
\newpage
\addcontentsline{toc}{chapter}{میری پہلی کتاب کا دیباچہ}
